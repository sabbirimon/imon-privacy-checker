...
final class RestApi {
    ...
    private function collect_client_signals( WP_REST_Request $request ): array {
        ...
        $allowed_top = array( 'user_agent', 'screen', 'color_depth', 'pixel_ratio', 'timezone', 'language', 'languages', 'platform', 'hardware_concurrency', 'device_memory', 'touch_support', 'cookies', 'do_not_track', 'webgl', 'canvas', 'audio', 'fonts', 'webrtc' );
        $out = array();
